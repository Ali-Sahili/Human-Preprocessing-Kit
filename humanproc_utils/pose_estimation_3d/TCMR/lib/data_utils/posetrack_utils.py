...
from ..core.config import TCMR_DB_DIR
from ..utils.utils import tqdm_enumerate
from ._feature_extractor import extract_features
from ._kp_utils import get_posetrack_original_kp_names, convert_kps
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, help='dataset directory', default='pose_estimation_3d/TCMR/data/posetrack')
