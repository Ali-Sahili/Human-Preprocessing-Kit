...
from ..core.config import TCMR_DB_DIR, BASE_DATA_DIR
from ..utils.utils import tqdm_enumerate
from ._kp_utils import convert_kps
from ._img_utils import get_bbox_from_kp2d
from ._feature_extractor import extract_features

from ._occ_utils import load_occluders
from ..models.smpl import H36M_TO_J14, SMPL_MODEL_DIR, SMPL
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, help='dataset directory', default='pose_estimation_3d/TCMR/data/h36m')
