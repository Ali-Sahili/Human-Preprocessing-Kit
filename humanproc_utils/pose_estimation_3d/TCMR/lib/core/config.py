...
TCMR_DB_DIR = 'pose_estimation_3d/TCMR/data/preprocessed_data'
AMASS_DIR = 'pose_estimation_3d/TCMR/data/amass'
INSTA_DIR = 'pose_estimation_3d/TCMR/data/insta_variety'
MPII3D_DIR = 'pose_estimation_3d/TCMR/data/mpi_inf_3dhp'
THREEDPW_DIR = 'pose_estimation_3d/TCMR/data/3dpw'
H36M_DIR = 'pose_estimation_3d/TCMR/data/h36m'
PENNACTION_DIR = 'pose_estimation_3d/TCMR/data/penn_action'
POSETRACK_DIR = 'pose_estimation_3d/TCMR/data/posetrack'
BASE_DATA_DIR = 'pose_estimation_3d/TCMR/data/base_data'
...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, default='./pose_estimation_3d/TCMR/configs/config.yaml', help='cfg file path')
