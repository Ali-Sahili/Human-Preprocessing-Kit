...
# CONSTANTS
MY_ROOT = "pose_estimation_3d/vibe/"
# You may modify them at will
VIBE_DB_DIR = f'{MY_ROOT}data/vibe_db'
AMASS_DIR = f'{MY_ROOT}data/amass'
INSTA_DIR = f'{MY_ROOT}data/insta_variety'
MPII3D_DIR = f'{MY_ROOT}data/mpi_inf_3dhp'
THREEDPW_DIR = f'{MY_ROOT}data/3dpw'
PENNACTION_DIR = f'{MY_ROOT}data/penn_action'
POSETRACK_DIR = f'{MY_ROOT}data/posetrack'
VIBE_DATA_DIR = f'{MY_ROOT}data/vibe_data'
