...
def download_ckpt(outdir='pose_estimation_3d/vibe/data/vibe_data', use_3dpw=False):
    os.makedirs(outdir, exist_ok=True)

    if use_3dpw:
        ckpt_file = 'pose_estimation_3d/vibe/data/vibe_data/vibe_model_w_3dpw.pth.tar'
        url = 'https://www.dropbox.com/s/41ozgqorcp095ja/vibe_model_w_3dpw.pth.tar'
        if not os.path.isfile(ckpt_file):
            download_url(url=url, outdir=outdir)
    else:
        ckpt_file = 'pose_estimation_3d/vibe/data/vibe_data/vibe_model_wo_3dpw.pth.tar'
