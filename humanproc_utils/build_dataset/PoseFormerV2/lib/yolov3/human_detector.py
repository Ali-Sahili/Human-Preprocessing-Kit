...
cur_dir = "build_dataset/PoseFormerV2/lib/yolov3/"
...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default= 'build_dataset/PoseFormerV2/lib/checkpoint/yolov3.weights', help='The path'
